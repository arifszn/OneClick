...
const Navbar = () => {
  return (
    <div className="inset-x-0 top-0 z-50 w-full transition duration-200 ease-in-out border-b border-transparent bg-transparent absolute text-primary-content">
