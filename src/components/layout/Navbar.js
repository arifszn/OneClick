...
const Navbar = ({query, setQuery}) => {
    ...
    const changeTheme = (e, selectedTheme) => {
        ...
        localStorage.setItem('dot-new-theme', selectedTheme);
            ...
            <div className="mx-auto space-x-1 navbar max-w-none">
                <div className={`${!scrolled ? 'hidden' : 'hidden md:flex items-center flex-none'}`}>
                    ...
                    >
                        <div className="inline-block text-2xl font-light">
                            <span className="text-base-content capitalize">Dot</span>{' '}<span className="text-primary capitalize">New</span>
                        </div>
                    </a>
                </div>
                ...
                <div>
                    <input 
                        ...
                        className={`w-full input input-ghost placeholder-current text-current focus:text-current focus:bg-transparent text-center ${scrolled ? 'input-bordered border-current' : ''}`}
                        value={query}
                ...
                <div title="Github" className="items-center flex-none">
                    <a aria-label="Github" target="_blank" href="https://github.com/arifszn/dotnew" rel="noreferrer" className="normal-case btn btn-ghost drawer-button btn-square">
