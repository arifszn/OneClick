...
export const actions = [
    ...
    {
        name: 'BeFunky',
        icon: <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1054.7 327.8" width={iconSize} height={iconSize}><path d="M50.4 83l80.2 80.3V76.6A95.5 95.5 0 0050.4 83z" fill="#ffa101" opacity=".8"></path><path d="M122.8 74v113.6l61.3-61.3a95.5 95.5 0 00-61.3-52.2z" fill="#f7ed00" opacity=".8"></path><path d="M180.3 119l-80.2 80.2h86.6a95.5 95.5 0 00-6.4-80.2z" fill="#b5dd01" opacity=".8"></path><path d="M189.3 191.4H75.7l61.3 61.3a95.5 95.5 0 0052.3-61.3z" fill="#60c660" opacity=".8"></path><path d="M144.4 249L64 168.6v86.6a95.5 95.5 0 0080.3-6.4z" fill="#668fd1" opacity=".8"></path><path d="M10.7 205.6a95.5 95.5 0 0061.2 52.2V144.3z" fill="#9869bc" opacity=".8"></path><path d="M8 132.7a95.5 95.5 0 006.4 80.3l80.3-80.3z" fill="#d35f99" opacity=".8"></path><path d="M57.7 79.3a95.5 95.5 0 00-52.2 61.2H119z" fill="#e54838" opacity=".8"></path><circle cx="97.4" cy="166" r="89.9" fill="none"></circle><g fill="currentcolor"><path d="M1038.8 78.4l-58.4 160.9-58.9-137a43.7 43.7 0 00-69.9-14.6l-91.2 84.9.1-172.6h-15v230a18.4 18.4 0 01-36.9 0v-87a67.6 67.6 0 00-67.5-67.6h-5a67.6 67.6 0 00-67.5 67.5v52.9a52.6 52.6 0 01-52.5 52.5h-.7a52.6 52.6 0 01-52.5-52.5v-89.9a27.5 27.5 0 00-27.5-27.5h-33.8V31.6c0-8.8 7.2-16.5 15.5-16.5h27.5V0h-27.5a31.4 31.4 0 00-30.5 31.5v46.8h-39v15h39V260h15V93.4h33.8A12.5 12.5 0 01448 106v89.9a67.6 67.6 0 0067.5 67.5h.7a67.6 67.6 0 0067.5-67.5v-52.9a52.6 52.6 0 0152.5-52.5h5a52.6 52.6 0 0152.5 52.5v87a33.4 33.4 0 0066.8 0v-36.8l38.7-36 80.4 102.8h19l-88.4-113L862 98.5a28.7 28.7 0 0145.8 9.7L973 259.9l-13.8 38a22.6 22.6 0 01-21.1 15h-16.4v15H938a37.6 37.6 0 0035.2-24.8l81.5-224.7zM270.4 76.4a79 79 0 00-78.1 67.8A97.4 97.4 0 0015 114.1V0H0V166a97.4 97.4 0 00192 22.7 84.3 84.3 0 0083.7 74.6c29.5 0 59-17.5 72.3-42.7h-17.6a69.5 69.5 0 01-54.7 27.7 69.2 69.2 0 01-69.2-69.2V177h142.8v-21.7c0-23.4-8-43.4-23.3-57.8a80 80 0 00-55.6-21zm-173 172A82.5 82.5 0 0115 166v-.2a82.4 82.4 0 1182.4 82.5zm236.8-86.5H206.6v-6.7a64 64 0 0163.9-63.8c17.7 0 33.8 6 45.3 16.8a62.8 62.8 0 0118.5 47z"></path></g></svg>,
