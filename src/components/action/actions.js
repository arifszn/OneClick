...
export const actions = [
    ...
    },
    {
        ...
        description: 'Start a new Jamboard with Google.',
        url: 'https://jam.new'
    },
    {
        name: 'GitHub',
    ...
    {
        name: 'GitHub Gist',
        icon: <svg aria-hidden="true" height="24" viewBox="0 0 25 16" width={iconSize} height={iconSize}><path fill="currentcolor" d="M4.7 8.73h2.45v4.02c-.55.27-1.64.34-2.53.34-2.56 0-3.47-2.2-3.47-5.05 0-2.85.91-5.06 3.48-5.06 1.28 0 2.06.23 3.28.73V2.66C7.27 2.33 6.25 2 4.63 2 1.13 2 0 4.69 0 8.03c0 3.34 1.11 6.03 4.63 6.03 1.64 0 2.81-.27 3.59-.64V7.73H4.7v1zm6.39 3.72V6.06h-1.05v6.28c0 1.25.58 1.72 1.72 1.72v-.89c-.48 0-.67-.16-.67-.7v-.02zm.25-8.72c0-.44-.33-.78-.78-.78s-.77.34-.77.78.33.78.77.78.78-.34.78-.78zm4.34 5.69c-1.5-.13-1.78-.48-1.78-1.17 0-.77.33-1.34 1.88-1.34 1.05 0 1.66.16 2.27.36v-.94c-.69-.3-1.52-.39-2.25-.39-2.2 0-2.92 1.2-2.92 2.31 0 1.08.47 1.88 2.73 2.08 1.55.13 1.77.63 1.77 1.34 0 .73-.44 1.42-2.06 1.42-1.11 0-1.86-.19-2.33-.36v.94c.5.2 1.58.39 2.33.39 2.38 0 3.14-1.2 3.14-2.41 0-1.28-.53-2.03-2.75-2.23h-.03zm8.58-2.47v-.86h-2.42v-2.5l-1.08.31v2.11l-1.56.44v.48h1.56v5c0 1.53 1.19 2.13 2.5 2.13.19 0 .52-.02.69-.05v-.89c-.19.03-.41.03-.61.03-.97 0-1.5-.39-1.5-1.34V6.94h2.42v.02-.01z"></path></svg>,
    ...
    {
        name: 'Codespace',
        icon: <svg viewBox="0 0 33 32" xmlns="http://www.w3.org/2000/svg" width={iconSize} height={iconSize}><title>codespace-logomark</title><g fill="none" fill-rule="evenodd"><rect fill="#50FC7C" x="11.4" width="14.1" height="4.5" rx="2.25"></rect><rect fill="#F75499" x="4.5" y="6.9" width="27.9" height="4.5" rx="2.25"></rect><rect fill="#7E8CE5" x="11.4" y="27.3" width="14.1" height="4.5" rx="2.25"></rect><rect fill="#FFED6F" y="13.8" width="14.1" height="4.5" rx="2.25"></rect><rect fill="#87E3F7" x="4.5" y="20.4" width="27.9" height="4.5" rx="2.25"></rect></g></svg>,
    ...
    },
    {
        ...
        description: 'Open up a sandbox for your next development project with Node.js.',
    ...
    },
    {
        ...
        icon: <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 17 17" width={iconSize} height={iconSize}>
          <path fill="#FDBD28" fill-rule="evenodd" d="M8.88.56a7.9 7.9 0 010 15.8 7.9 7.9 0 010-15.8zm-6.23 7.9c0 .45.05.88.14 1.3 0 .03.06.03.06 0A6 6 0 018.88 3.8c.29 0 .52.23.52.51 0 .29-.23.52-.52.52a4.97 4.97 0 00-5 4.92c0 .06.07.07.09.02.65-1.92 2.65-3.25 4.91-3.25.29 0 .52.23.52.51 0 .29-.23.52-.52.52-2.33 0-4.1 1.66-4.1 3.56 0 1.9 1.77 3.57 4.1 3.57a6.22 6.22 0 006.09-7.59c-.01-.02-.05-.02-.05 0a5.9 5.9 0 01-5.9 5.9.52.52 0 01-.52-.52c0-.28.23-.51.51-.51 2.7 0 4.89-2.18 4.89-4.86 0-.04-.06-.05-.07-.01A4.98 4.98 0 019 10.4a.52.52 0 01-.51-.52c0-.28.23-.51.51-.51C11.27 9.37 13 7.72 13 5.8c0-1.7-1.38-3.2-3.28-3.5a6.22 6.22 0 00-7.07 6.16z" clip-rule="evenodd"></path></svg>,
    ...
    },
    {
        ...
        description: 'Build your website using Editor X\'s online tool.',
